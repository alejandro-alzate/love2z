...
function love.thread.getChannel(name) return Channel end
...
function love.thread.newChannel() return Channel end
...
function love.thread.newThread(filename) return Thread end
...
--- @return Thread thread A new Thread that has yet to be started.
--- @diagnostic disable-next-line: duplicate-set-field
function love.thread.newThread(fileData) return Thread end
...
--- @return Thread thread A new Thread that has yet to be started.
--- @diagnostic disable-next-line: duplicate-set-field
function love.thread.newThread(codestring) return Thread end
