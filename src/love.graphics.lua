...
function love.graphics.getBlendMode() return BlendMode, BlendAlphaMode end

--- Gets the current target Canvas.
---
--- @return Canvas canvas The Canvas set by setCanvas. Returns nil if drawing to the real screen.
function love.graphics.getCanvas() return Canvas end
...
function love.graphics.getDefaultFilter() return FilterMode, FilterMode, 0 end
...
function love.graphics.getDepthMode() return CompareMode, true end
...
function love.graphics.getFrontFaceWinding() return VertexWinding end
...
function love.graphics.getLineJoin() return LineJoin end

--- Gets the line style.
---
--- @return LineStyle style The current line style.
function love.graphics.getLineStyle() return LineStyle end
...
function love.graphics.getMeshCullMode() return CullMode end
...
function love.graphics.getShader() return Shader end
...
function love.graphics.getStencilTest() return CompareMode, 0 end
...
function love.graphics.newArrayImage(slices, settings) return Image end

--- Creates a new Canvas object for offscreen rendering.
---
--- @return Canvas canvas A new Canvas with dimensions equal to the window's size in pixels.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newCanvas() return Canvas end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newCanvas(width, height) return Canvas end
...
--- @return Canvas canvas A new Canvas with specified width and height.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newCanvas(width, height, settings) return Canvas end
...
--- @return Canvas canvas A new Canvas with specified width and height.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newCanvas(width, height, layers, settings) return Canvas end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newCubeImage(filename, settings) return Image end
...
--- @return Image image An cubemap Image object.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newCubeImage(faces, settings) return Image end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newFont(filename) return Font end
...
--- @return Font font A Font object which can be used to draw text on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newFont(filename, size, hinting, dpiscale) return Font end
...
--- @return Font font A Font object which can be used to draw text on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newFont(filename, imagefilename) return Font end
...
--- @return Font font A Font object which can be used to draw text on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newFont(size, hinting, dpiscale) return Font end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImage(filename, settings) return Image end
...
--- @return Image image A new Image object which can be drawn on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImage(fileData, settings) return Image end
...
--- @return Image image A new Image object which can be drawn on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImage(imageData, settings) return Image end
...
--- @return Image image A new Image object which can be drawn on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImage(compressedImageData, settings) return Image end
...
--- @return Font font A Font object which can be used to draw text on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImageFont(filename, glyphs) return Font end
...
--- @return Font font A Font object which can be used to draw text on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImageFont(imageData, glyphs) return Font end
...
--- @return Font font A Font object which can be used to draw text on screen.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newImageFont(filename, glyphs, extraspacing) return Font end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newMesh(vertices, mode, usage) return Mesh end
...
--- @return Mesh mesh The new mesh.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newMesh(vertexcount, mode, usage) return Mesh end
...
--- @return Mesh mesh The new mesh.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newMesh(vertexformat, vertices, mode, usage) return Mesh end
...
--- @return Mesh mesh The new mesh.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newMesh(vertexformat, vertexcount, mode, usage) return Mesh end
...
--- @return Mesh mesh The new mesh.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newMesh(vertexcount, texture, mode) return Mesh end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newParticleSystem(image, buffer) return ParticleSystem end
...
--- @return ParticleSystem system A new ParticleSystem.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newParticleSystem(texture, buffer) return ParticleSystem end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newQuad(x, y, width, height, sw, sh) return Quad end
...
--- @return Quad quad The new Quad.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newQuad(x, y, width, height, texture) return Quad end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newShader(code) return Shader end
...
--- @return Shader shader A Shader object for use in drawing operations.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newShader(pixelcode, vertexcode) return Shader end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newSpriteBatch(image, maxsprites) return SpriteBatch end
...
--- @return SpriteBatch spriteBatch The new SpriteBatch.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newSpriteBatch(image, maxsprites, usage) return SpriteBatch end
...
--- @return SpriteBatch spriteBatch The new SpriteBatch.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newSpriteBatch(texture, maxsprites, usage) return SpriteBatch end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newText(font, textstring) return Text end
...
--- @return Text text The new drawable Text object.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newText(font, coloredtext) return Text end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newVideo(filename) return Video end
...
--- @return Video video A new Video.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newVideo(videostream) return Video end
...
--- @return Video video A new Video.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newVideo(filename, settings) return Video end
...
--- @return Video video A new Video.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newVideo(filename, loadaudio) return Video end
...
--- @return Video video A new Video.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.newVideo(videostream, loadaudio) return Video end
...
function love.graphics.newVolumeImage(layers, settings) return Image end
...
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.setNewFont(size) return Font end
...
--- @return Font font The new font.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.setNewFont(filename, size) return Font end
...
--- @return Font font The new font.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.setNewFont(file, size) return Font end
...
--- @return Font font The new font.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.setNewFont(data, size) return Font end
...
--- @return Font font The new font.
--- @diagnostic disable-next-line: duplicate-set-field
function love.graphics.setNewFont(rasterizer) return Font end
